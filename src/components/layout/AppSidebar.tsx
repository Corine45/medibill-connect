  ...
  superadmin: [
    {
      ...
      items: [
        ...
        { title: "Gestion Abonnés", url: "/admin/patients", icon: UserCheck },
  ...
  provider: [
    {
      ...
      items: [
        ...
        { title: "Mes Abonnés", url: "/provider/patients", icon: UserCheck },
  ...
  pharmacy: [
    {
      ...
      items: [
        ...
        { title: "Mes Abonnés", url: "/pharmacy/patients", icon: UserCheck },
